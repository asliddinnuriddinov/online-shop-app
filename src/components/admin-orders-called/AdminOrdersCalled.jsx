...
const AdminOrdersCalled = () => {
  const data=useSelector(state=>state?.orderProducts?.orderProducts?.at(0)?.filter(x=>x.contacted==true));
...
export default AdminOrdersCalled