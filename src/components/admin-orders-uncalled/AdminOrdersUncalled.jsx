...
import "./AdminOrdersUncalled.scss"
...
const AdminOrdersUncalled = () => {
  const data=useSelector(state=>state?.orderProducts?.orderProducts?.at(0)?.filter(x=>x.contacted==false));
                    ...
                    <div key={x._id} className="orders__all__item">
                        ...
                        <div className="orders__product-info">
                            <div className="orders__product-count">
                                ...
                                <span>{x.orderedproducts[0].quantity}</span>
                            </div>
                            <div className="orders__product-price">
                                <p>Маҳсулот умумий нархи:  </p>
                                <span>{x.orderedproducts[0].quantity*x.orderedproducts[0].cost} CУМ</span>
                            </div>
                        </div>
...
export default AdminOrdersUncalled